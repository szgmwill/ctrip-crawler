...
ALI_BASE = Config.BASE_URL['alitrip']
...
def get_response(query, url_base):
    ...
    ali_url = url_base.format(dp=dp,rp=rp,dt=query[0].dt,rt=query[0].rt)
    print ali_url
...
def init_files(dir_path):
    filename1 = dir_path + '/round_alitrip_quotes.csv'
    ...
    filename2 = dir_path + '/round_alitrip_fails.csv'
...
def alitrip_scraper_round(query_lst, dir_path):
